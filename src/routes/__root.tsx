...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Agenda — Calendário e Notas" },
      { name: "description", content: "Agenda compartilhada com calendário interativo e bloco de notas pessoais." },
      { property: "og:title", content: "Agenda — Calendário e Notas" },
      { name: "twitter:title", content: "Agenda — Calendário e Notas" },
